...
class AspectRatioConfigurationWidget(forms.Widget):
    ...
    def get_context(self, name, value, attrs):
        ...
        # Получаем все популярные соотношения
        presets = AspectRatioPreset.objects.filter(is_common=True).order_by('order')
...
class AspectRatioConfigurationFormMixin:
    ...
    def __init__(self, *args, **kwargs):
        ...
        model_type = 'image' if hasattr(self.instance, 'imagemodelconfiguration') else 'video'
    ...
    def _save_aspect_ratio_configurations(self, instance):
        ...
        model_type = 'image' if hasattr(instance, 'imagemodelconfiguration') else 'video'
        ...
        if configs_json:
            try:
                ...
                print(f"Error saving aspect ratio configurations: {e}")
